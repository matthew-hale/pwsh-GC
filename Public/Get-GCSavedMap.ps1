function Get-GCSavedMap {
	...
	param (
		...
		[ValidateSet("READY","IN_PROGRESS","QUEUED","CANCELLED","FAILED","EMPTY")][System.String]$State,

		[ValidateSet("include_processes","time_resolution")]$Features,
