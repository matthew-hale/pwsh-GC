...
<#
Returns correctly formatted authentication header within a headers object for GET requests given an auth token INPUTS;
...
.PARAMETER OutPath
	[System.String] Destination directory for the generated csv files. Note the potential for many files to be generated.
...
Function Get-GCNetworkFlows {
	...
	[cmdletbinding()]
	Param (
		[Parameter(Mandatory=$true)][System.Int64]$StartTime,
		[Parameter(Mandatory=$true)][System.Int64]$EndTime,
		...
		[Parameter(Mandatory=$true)][ValidateScript({Test-Path $_})][System.String]$OutPath
	)
	Begin {
